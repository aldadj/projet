...
<div class="max-w-4xl mx-auto px-6 py-12">
    ...
    {{-- Fil d'Ariane / Retour --}}
    <div class="mb-8">
        <a href="{{ route('admin.dashboard') }}" class="group flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-[#bb1919] transition-colors">
    ...
    <div class="bg-white border border-gray-200 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden">
        ...
        <form action="{{ route('admin.article.store') }}" method="POST" enctype="multipart/form-data" class="p-10 space-y-8">
            @csrf
