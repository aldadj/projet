    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 border-b-4 border-[#212121] pb-6">
        <div>
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="text-gray-400 text-[10px] font-black uppercase tracking-widest">ID: #<?php echo e($article->id); ?></span>
            </div>
            <h1 class="text-4xl font-black text-[#212121] uppercase tracking-tighter">Modifier <span class="text-[#bb1919]">l'Article</span></h1>
        </div>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="group flex items-center gap-2 text-xs font-black uppercase tracking-widest text-gray-500 hover:text-[#212121] transition-colors">
                ...
                <div class="bg-white border border-gray-200 shadow-sm p-8">
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" name="title" 
                               ...
                               value="<?php echo e(old('title', $article->title)); ?>" required placeholder="Saisir le titre...">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <textarea name="content" rows="25" 
                                      ...
                                      placeholder="Rédigez votre contenu ici..."><?php echo e(old('content', $article->content)); ?></textarea>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="p-6 bg-[#f9f9f9] border border-gray-100">
                    <p class="text-[10px] font-bold text-gray-400 leading-relaxed uppercase">
                        ...
                        <span class="text-[#212121]"><?php echo e($article->updated_at->format('d/m/Y à H:i')); ?></span>
                    </p>
                </div>
            </div>
        </div>
