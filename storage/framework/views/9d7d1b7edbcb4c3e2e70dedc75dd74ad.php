        ...
        <div class="p-6 border-b border-gray-700 bg-gray-900/30 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <span class="text-lg font-bold text-white"><?php echo e($message->name); ?></span>
                </div>
                <a href="mailto:<?php echo e($message->email); ?>" class="text-blue-400 hover:text-blue-300 text-sm flex items-center gap-1 transition-colors">
            ...
            <div class="text-gray-400 text-sm bg-gray-700/50 px-3 py-1 rounded-full">
                Reçu le <?php echo e($message->created_at->format('d/m/Y à H:i')); ?>
